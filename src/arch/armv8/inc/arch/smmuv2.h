...
#define SMMU_SMR_MASK(smr) \
    bit_extract(smr, SMMU_SMR_MASK_OFF, SMMU_SMR_MASK_LEN)
...
#define S2CR_TRANSIENTCFG_MASK \
    BIT_MASK(S2CR_TRANSIENTCFG_OFF, S2CR_TRANSIENTCFG_LEN)
