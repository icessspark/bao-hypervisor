...
{
    *features |= VIRTIO_F_VERSION_1;  // This indicates compliance with this
                                      // specification,
    // giving a simple way to detect legacy devices or drivers.
    *features |= VIRTIO_BLK_F_SIZE_MAX;
    // *features |= VIRTIO_BLK_F_SIZE_MAX;       /* Indicates maximum segment
    // size */
    ...
    if (!acc->write) {
        ...
        switch (offset) {
            ...
            case VIRTIO_MMIO_HOST_FEATURES:
                ...
                //                printk("read VIRTIO_MMIO_HOST_FEATURES
                //                0x%x\n\r", value);
                break;
            case VIRTIO_MMIO_QUEUE_NUM_MAX:
                value = virtio_mmio->regs.q_num_max;
                //                printk("read VIRTIO_MMIO_QUEUE_NUM_MAX
                //                0x%x\n\r", value);
                break;
            case VIRTIO_MMIO_QUEUE_READY:
                value = virtio_mmio->regs.q_ready;
                //                printk("read VIRTIO_MMIO_QUEUE_READY
                //                0x%x\n\r", value);
                break;
            ...
            case VIRTIO_MMIO_CONFIG_GENERATION:
                ...
                //                printk("read VIRTIO_MMIO_CONFIG_GENERATION
                //                0x%x\n\r", value);
                break;
        ...
        switch (offset) {
            ...
            case VIRTIO_MMIO_GUEST_FEATURES:
                ...
                //                printk("write VIRTIO_MMIO_GUEST_FEATURES
                //                0x%x!\n\r", value);
