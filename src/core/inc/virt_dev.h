...
#define	VIRTIO_BLK_F_DISCARD	    1ULL << 13      // Not support by virtio_blk driver in linux 4.19
#define	VIRTIO_BLK_F_WRITE_ZEROES	1ULL << 14      // Not support by virtio_blk driver in linux 4.19
