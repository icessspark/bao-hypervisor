...
typedef struct {
    ...
    volatile uint32_t
        status_error;  // UART Receive Status Register/Error Clear Register
    ...
    volatile uint32_t
        isr_fifo_level_sel;      // UART Interrupt FIFO level Select Register
    ...
    volatile uint32_t
        masked_isr_status;          // UART Masked Interrupt Status Register
